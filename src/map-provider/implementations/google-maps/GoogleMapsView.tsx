...
/**
 * Reads map heading via polling instead of heading_changed to avoid recursive
 * event loops with setHeading calls.
 */
...
/**
 * In north-up mode: resets heading to 0 once.
 * In follow-heading mode: continuously drives heading from device compass,
 *   and drops to 'free' if the user drags.
 * In free mode: does nothing.
 */
